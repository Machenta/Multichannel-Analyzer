...
class Arduino:
    def __init__(self, port, baud, n_acquisitions=1, acquisition_time=5, filename="analog-data.csv", sensor_data_all=[], n_channels=10):
        self.port = port
        self.baud = baud
    ...
    def get_data_time_loop(self,sensor_data, dictionary, all_data):
    ...
    def get_data_acquisition_loop(self, all_data):
        ...
        while time.time() < timeout:
            self.get_data_time_loop(sensor_data=sensor_data, dictionary=data_dict, all_data=all_data)
